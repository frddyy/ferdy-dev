...
export const projects = [
  // --- TIER 1: THE POWER FIVE (Fully Expanded Apple Narrative) ---
  {
    ...
    details: {
      problem:
        "Engineering teams frequently over-provision cloud infrastructure to 'play it safe,' leading to massive AWS billing bloat and a severe environmental carbon footprint. Furthermore, manually auditing proposed architectures against dense AWS best-practice whitepapers is highly time-consuming and prone to human error.",
      solution:
        "I engineered a custom Vector Store RAG pipeline using Langflow, Astra DB, and Google Generative AI. To bypass rate limits, I built a batch ingestion pipeline that chunked a 135-page AWS Cost Optimization Whitepaper into sequential micro-batches. I then injected an 'Elite Cloud Architect' persona to rigorously analyze user prompts against the vectorized data.",
      impact:
        "Delivered a dual-impact AI auditor for DevOps and FinOps teams. The agent analyzes architecture proposals in real-time and generates structured Markdown reports highlighting cost risks, sustainability impacts, and actionable right-sizing recommendations (e.g., adopting Serverless or AWS Graviton) before a single line of infrastructure code is written.",
    },
    tech: [
      "Langflow",
      "Gemini 2.5 Flash",
    ...
    images: [
      "/assets/images/portfolio/greenops-langflow/1.jpeg",
      "/assets/images/portfolio/greenops-langflow/2.jpeg",
      "/assets/images/portfolio/greenops-langflow/3.jpeg",
      "/assets/images/portfolio/greenops-langflow/4.jpeg",
      "/assets/images/portfolio/greenops-langflow/5.jpeg",
      "/assets/images/portfolio/greenops-langflow/6.jpeg",
    ],
  },
  {
    slug: "podface",
    ...
    year: "2025",
    link: "https://youtu.be/MA1jYBcgqNA?si=aJL8YvKqdNfILxCW",
    images: [
  ...
  },
  {
    ...
    summary:
      "A real-time, multi-tenant attendance management system utilizing precise geofencing to automate check-ins and reduce HR administrative burdens.",
    details: {
      problem:
        "Multiple client companies struggled with employee discipline due to inaccurate, decentralized attendance tracking, creating a massive administrative bottleneck for HR departments calculating payroll.",
      solution:
        "I led a 10+ developer team from requirements analysis to implementation. I engineered a backend scheduler to automate late arrivals and check-outs, and bypassed React Native native module limitations by customizing an alternative GPS library for strict geofencing accuracy.",
      impact:
        "Successfully transitioned an internal tool into an adopted commercial product. I learned how to navigate critical framework limitations and manage cross-functional communication to deliver enterprise-grade accuracy.",
    },
  ...
  },
  {
    ...
    summary:
      "A cross-platform web and mobile application for personalized recipe management, utilizing a unified backend architecture.",
    details: {
      problem:
        "The project required validating that a single backend could efficiently serve diverse frontend clients without performance degradation or inconsistent API contracts.",
      solution:
        "I owned all mobile UI development and REST API integrations, working concurrently with web developers to map out strict data fetching and authentication strategies across both platforms.",
      impact:
        "Delivered a robust UI that served as a technical benchmark for evaluating future OJT candidates. It solidified my cross-platform development skills and taught me how to architect seamless multi-client API interactions.",
    },
  ...
  },
  {
    ...
    images: ["/assets/images/portfolio/payment-gateway/image.png"],
  },
  {
    slug: "emosync",
    ...
    summary:
      "A human-centric AI experiment integrating YOLOv8 face detection with Spotify APIs to translate real-time facial expressions into personalized music curation.",
    details: {
      problem:
        "Digital music curation often relies on past listening history rather than a user's current, real-time emotional state.",
      solution:
        "I integrated hardware (webcam) with computer vision (YOLOv8) to detect human emotions, mapping those real-time data points to Spotify's recommendation algorithms.",
      impact:
        "Showcased an interdisciplinary approach to connecting hardware, software, and emotional UX. I learned how to build fluid user experiences that react immediately to non-traditional data inputs like facial expressions.",
    },
  ...
  },
  {
    ...
    role: "Fullstack Developer",
    summary:
      "A Progressive Web App designed to simplify personal financial management through intuitive data visualization and real-time recap tracking.",
    details: {
      problem:
        "Many users find traditional budgeting tools either too complex or poorly optimized for quick, daily entry. This friction often leads to inconsistent tracking, leaving users without a clear understanding of their cash flow, total balance across multiple accounts, or how their actual spending aligns with their monthly goals.",
      solution:
        "I developed SpendWise as a Progressive Web App (PWA) to provide a mobile-first, cross-platform experience that ensures high accessibility. Using React and Chakra UI, I engineered a responsive dashboard featuring real-time financial summaries and multi-wallet management. The backend, built with Express and PostgreSQL, powers advanced recap and reporting engines that transform raw transaction data into actionable monthly analytics.",
      impact:
  ...
  },
  {
    ...
    role: "Fullstack Developer",
    summary:
      "A web utility tool that allows users to input their data to generate formatted CVs and personal portfolio websites dynamically.",
    details: {
      problem:
        "Maintaining a consistent professional brand across both a static PDF CV and a personal website is often a repetitive and time-consuming process. Users struggle with manual formatting and the technical overhead required to keep their online presence synchronized with their latest professional milestones.",
      solution:
        "I architected a Fullstack solution using the PERN stack (MySQL, Express, React, Node) to centralize professional data. I developed a robust RESTful API to handle CRUD operations for user profiles, experience, and skills. By utilizing React's state management, I enabled a real-time 'live preview' system where user inputs are dynamically injected into pre-designed CV templates and hosted personal web layouts.",
      impact:
        "As the lead developer, I gained significant experience in designing scalable RESTful architectures and managing collaborative task delegation. This project deepened my understanding of handling complex nested forms and user-generated content, ultimately delivering a system that bridges the gap between raw data entry and professional visual presentation.",
    },
