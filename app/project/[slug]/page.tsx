...
export default async function ProjectDetail({ params }: Props) {
  ...
  const isYouTube = project.link ? (project.link.includes("youtube.com") || project.link.includes("youtu.be")) : false;
  const youtubeId = isYouTube ? getYouTubeId(project.link!) : null;
            ...
            <div className="flex flex-col gap-1 md:col-span-1">
              ...
              <div className="flex flex-col gap-6 pt-8 border-t border-gray-200 dark:border-white/10 transition-colors">
                ...
                {project.link && (
                  <div className="pt-6">
                    <a 
                      // 1. If YouTube, anchor down to #video-demo. Else, standard external link
                      href={isYouTube ? "#video-demo" : project.link} 
                      // 2. If YouTube, don't open a new tab
                      target={isYouTube ? "_self" : "_blank"} 
                      rel={isYouTube ? "" : "noopener noreferrer"} 
                    ...
                    >
                      ...
                      ) : (project.link.includes("vimeo.com") || project.link.includes("drive.google.com")) ? (
                        <>
